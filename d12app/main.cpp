...
struct App
{
    App(HINSTANCE hInstance, HWND hWnd) : m_hInstance(hInstance), m_hWnd(hWnd) { }
    ...
    ID3D12CommandAllocator *m_cmdAllocator[SWAPCHAIN_BUFFER_COUNT] = {};
...
void App::beginFrame()
{
    ...
    m_drawCmdList->Reset(m_cmdAllocator[m_currentFrameSlot], nullptr);
    ...
    m_drawCmdList->ResourceBarrier(1, &rtBarrier);
}
...
void App::endFrame()
{
    ...
    m_drawCmdList->Close();
    ID3D12CommandList *commandLists[] = { m_drawCmdList };
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
    ...
    windowClass.lpszClassName = _T("d12app");
    ...
    HWND window = CreateWindow(windowClass.lpszClassName, _T("d12app"), windowStyle,
